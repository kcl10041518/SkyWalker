//
//  SkyWalkerMeViewController.swift
//  SkyWalker
//
...
class SkyWalkerMeViewController: SkyWalkerBaseViewController {

    override func viewDidLoad() {
        super.viewDidLoad()

        view.addSubview(self.tableView)
        self.showNavigationBar(title: "我的", leftString: "", rightString: "")
...
extension SkyWalkerMeViewController: UITableViewDelegate, UITableViewDataSource {
