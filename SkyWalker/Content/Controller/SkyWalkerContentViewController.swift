//
//  SkyWalkerContentViewController.swift
//  SkyWalker
//
...
class SkyWalkerContentViewController: SkyWalkerBaseViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
        
        view.addSubview(self.tableView)
        self.showNavigationBar(title: Localizable(key: "SkyWalkerContent"), leftString: "", rightString: "")
...
extension SkyWalkerContentViewController: UITableViewDelegate, UITableViewDataSource {
